...
VALUE ('White room - Doryssa', 'Προσφορά το λευκό δωμάτιο. Εξαιρετικό για διαμονή με την κοπέλα σας. Το σίγουρο είναι πως στο τέλος της νύχτας το λευκό δωμάτιο θα λεκιάσει...', 3, 0, 26, 60, 3, '//doryssa.gr/photos/Home_backgrounds_EN/backround_only_gardenview.jpg', NOW() + Interval 1 DAY ),
