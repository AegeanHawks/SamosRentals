...
('2 persom room - Samaina', 'Προσφορά μέτριας κατηγορίας δωμάτιο στο πυθαγόριο. Κοντά στην θάλλασα και στο χωρίο, είναι ότι πρέπει για να έχετε ένα σημείο ξεκούρασης κατα την διάρκεια των διακοπών σας.', 2, 0, 10, 25, 4, '//www.samaina-hotel-samos.com/pic-b/pic3-b.jpg;//www.samaina-hotel-samos.com/pic-b/pic9-b.jpg', NOW() + Interval 3 DAY ),
