                ...
                <div class="entry-content">
                    ...
                    <div class="col s12">
                        ...
                        <p class="grey-text darken-3">Το Samos Rentals περιέχει μια τεράστια βάση από 100+ δωμάτια και
                            ξενοδοχεία στο νησί. Αν έχεις ξενοδοχείο ή ενοικιαζόμενα δωμάτια τότε εγγράψου στην υπηρεσία
                            μας
        ...
        <div class="row">
            <div class="col m12 l10 offset-l1">
                ...
                <p class="grey-text darken-2 light flow-text center-align .disBlock">Το Samos Rentals είναι μια μοναδική
                    πλατφόρμα που
                    βοηθά τουρίστες και ιδιοκτήτες ξενοδοχείων να αλληλεπιδρούν ακόμα καλύτερα. Αν είσαι ξενοδόχος
                    μπορείς να διαφημίσες το ξενοδοχείο σου, καθώς και να αυξήσεις την πληρότητα των δωματίων σου μέσα
                    από την μοναδική διαδικτυακή μας πλατφόρμα. Αν πάλι ψάχνεις δωμάτιο τότε είσαι στο κατάλληλο σημέιο,
                    απλά να κάνε
                    κράτηση!</p>
            </div>
