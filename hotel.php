...
$sql = $con->prepare('SELECT Hotel.Name, Comforts,Tel,Hotel.Description,Coordinates,Manager,Hotel.Image,avg(auction.GradeOfHotel) as Grade FROM Hotel,auction WHERE Hotel.ID= ? GROUP BY Hotel.ID');
